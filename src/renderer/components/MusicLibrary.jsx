...
// subsequence match: every character of the query must appear in the target in order (not necessarily contiguous).
// lets "dpnk lv" find "Daft Punk - Make Love" without requiring an exact substring.
